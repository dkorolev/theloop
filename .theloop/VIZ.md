...
| [`InternalSkillValidateAllSkills`](../.skills/InternalSkillValidateAllSkills/SKILL.md) | Meta-skill that validates every skill in this repository against `.theloop/SKILLS-META-RULES.md`, by invoking `InternalSkillValidateSkill` once per skill and then performing the whole-repo checks. |
