...
Usage: .skills/theloop-internal-check-single-rule/scripts/rules.py parse <path-to-rule.yml>
       .skills/theloop-internal-check-single-rule/scripts/rules.py probe-one <path-to-rule.yml>
       .skills/theloop-internal-check-single-rule/scripts/rules.py write <path-to-rule.yml>
"""
import hashlib
import json
import os
