#!/usr/bin/env python3
"""Mechanical rule checks of theloop-internal-validate-skill against one target skill.

Usage: .skills/theloop-internal-validate-skill/scripts/mechanical-checks.py <SkillNameToCheck>   (from the repository root)
