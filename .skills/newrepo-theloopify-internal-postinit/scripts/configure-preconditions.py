#!/usr/bin/env python3
"""Check whether newrepo-theloopify-internal-postinit is allowed to run in this repository.

Usage: .skills/newrepo-theloopify-internal-postinit/scripts/configure-preconditions.py
...
def main():
    if os.path.exists(DONE):
        return refuse("already-configured",
                      f"{DONE} exists; newrepo-theloopify-internal-postinit runs at most once per clone")
