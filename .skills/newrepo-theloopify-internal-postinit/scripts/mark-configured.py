#!/usr/bin/env python3
"""Mark newrepo-theloopify-internal-postinit complete: write the done marker, remove the pending marker.

Usage: .skills/newrepo-theloopify-internal-postinit/scripts/mark-configured.py [--summary TEXT]
