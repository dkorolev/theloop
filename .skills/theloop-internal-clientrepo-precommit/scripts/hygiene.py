#!/usr/bin/env python3
"""Run the three receipt-hygiene checks of theloop-internal-clientrepo-precommit.

Usage: .skills/theloop-internal-clientrepo-precommit/scripts/hygiene.py   (from the repository root)
