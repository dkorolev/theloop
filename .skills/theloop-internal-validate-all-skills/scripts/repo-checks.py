#!/usr/bin/env python3
"""Whole-repo checks of theloop-internal-validate-all-skills.

Usage: .skills/theloop-internal-validate-all-skills/scripts/repo-checks.py   (from the repository root)
