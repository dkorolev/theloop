#!/usr/bin/env python3
"""Validate and write the run receipt of theloop-internal-validate-all-skills, write-once.
...
Usage (CLI — preferred):
  ...
  --sub-run-ids is a space-separated list of theloop-internal-validate-skill sub-run identifiers.
